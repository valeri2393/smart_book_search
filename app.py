...
df = pd.read_csv('/Users/valeriaalesnikova/Desktop/bootcamp/smart_book_search/data/csv_file.csv')
...
embeddings = np.loadtxt('/Users/valeriaalesnikova/Desktop/bootcamp/smart_book_search/notebooks/embeddings.txt')
